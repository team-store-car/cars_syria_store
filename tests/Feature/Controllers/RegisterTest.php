...
{
    use RefreshDatabase; // لاستعادة حالة قاعدة البيانات بعد كل اختبار
    ...
    {    $this->seed(\Database\Seeders\RoleSeeder::class);
        ...
        // 1. بيانات التسجيل الصالحة (افترضنا هذه الحقول بناءً على المعتاد)
        $userData = [
            'name'                  => 'Test User',
            'email'                 => 'testregister@example.com',
            'password'              => 'password123',
            'password_confirmation' => 'password123', // حقل تأكيد كلمة المرور ضروري غالبًا في RegisterRequest
            'role' => 'user', 
        ];
